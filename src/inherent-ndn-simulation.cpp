...
main(int argc, char* argv[])
{
  ...
  Ptr<Node> consumer6 = Names::Find<Node>("Rtr1");
  Ptr<Node> consumer7 = Names::Find<Node>("Rtr2");
  Ptr<Node> consumer8 = Names::Find<Node>("Rtr3");
  Ptr<Node> consumer9 = Names::Find<Node>("Rtr4");
  Ptr<Node> consumer10 = Names::Find<Node>("Rtr9");
  Ptr<Node> consumer11 = Names::Find<Node>("Rtr11");
  Ptr<Node> consumer12 = Names::Find<Node>("Rtr12");
  Ptr<Node> consumer13 = Names::Find<Node>("Rtr17");
  Ptr<Node> consumer14 = Names::Find<Node>("Rtr19");
